        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AzureAdUserId = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    UserPrincipalName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    DisplayName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    SelectedCalendarId = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friendships_AppUsers_FriendId",
                        column: x => x.FriendId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Friendships_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUsers_AzureAdUserId",
                table: "AppUsers",
                column: "AzureAdUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppUsers_UserPrincipalName",
                table: "AppUsers",
